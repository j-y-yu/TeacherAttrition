...
Developed for the _[Mitigating U.S. Public School Teacher Attrition Crisis with Machine Learning Approach](docs/2022-DS-Poster-SASS.pdf) project_ by [June Yu](https://www.linkedin.com/in/j-y-yu/), (data integration, analysis, feature selection, and modeling), [Li Feng](https://lifeng.wp.txstate.edu/) (domain expert), and [Jelena Tešić](https://jtesic.github.io) (project lead). 
